<div data-role="panel" data-title-caption="List Edit Barang" data-collapsible="true" data-title-icon="<span class='mif-chart-line'></span>" class="mt-4">
    <?php
    ...
    <div class="container">
        <form class="justify-content-center align-items-center" action="<?= $base_url . 'barang/ubah/' . $edit['idbarang'] ?>" method="post">
            <div>
