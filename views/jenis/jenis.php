<div data-role="panel" data-title-caption="List Jenis" data-collapsible="true" data-title-icon="<span class='mif-chart-line'></span>" class="mt-4">
    <table class="table row-hover">
        <a class="button outline success mb-3" href="<?= $base_url; ?>jenis/add/"> Create data</a>
        <thead>
            <th>Nomor</th>
            <th>Jenis Barang</th>
            <th>Ket</th>
        ...
        ?>
            <tbody>
                ...
                <td><a class="button info" href="<?= $base_url . 'jenis/edit/' . $jenis['idjenis'] ?>"> <span class="mif-pencil"></span></a>
                    <a class="button alert" href="<?= $base_url . 'jenis/hapus/' . $jenis['idjenis'] ?>" onclick="return confirm('yakin dihapus?')"><span class="mif-bin"></span></a>
                </td>
            </tbody>
        <?php
            $no++;
